...
public class RmFundAPI {
    ...
    @ApiOperation(httpMethod = "POST", value = "(<font color='blue'>我的约谈</font>)",position = 2,nickname = "我的约谈", notes = "<font color='green'>传递参数</font>:<br>" +
            "<table border=\"1\">" +
            "<tr><th>字段</th><th>是否为空</th><th>\t备注</th></tr>" +
            "<tr><td>token</td><td>否</td><td>token</td></tr>" +
            "<tr><td>pageNow</td><td>否</td><td>当前页码(从1开始)</td></tr>" +
            "<tr><td>pageSize</td><td>否</td><td>每页显示多少条</td></tr>" +
            "</table>"+
            "<h4>没有数据的情况返回:</h4><div class=\"block response_body json\"><pre class=\"json\"><code>{\r\"code\":0,\r\"message\":\"成功\",\r\"data\":null\r}</code></pre></div>"+
            "<h4>有数据时返回:</h4><div class=\"block response_body json\"><pre class=\"json\"><code>{\n\"code\":0,\n\"message\":\"成功\",\n\"data\":\n[\r{\r\"rmFundName\":\"晨晖新经济产业并购投资基金\",\n\"preDate\":1477411200000\n}," +
    ...
    @ResponseBody
    public Object step3(@RequestParam String token,@RequestParam int pageNow,@RequestParam int pageSize, HttpServletRequest request) {
        String myJsonData="";
        return myJsonData;
    }
